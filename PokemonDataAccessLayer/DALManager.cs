...
namespace PokemonDataAccessLayer
{
    public class DALManager
    {
        ...
        private void CreerMonde()
        {
            ...
            Pokemon p1 = new Pokemon("Electhor", 200, 75, 30, new List<TypeElement>() { TypeElement.Electrique, TypeElement.Vol },  @"\Images\electhor.png");
            Pokemon p2 = new Pokemon("Brasegali", 160, 90, 25, new List<TypeElement>() { TypeElement.Feu }, @"\Images\Brasegali.png");
            Pokemon p3 = new Pokemon("Onigali", 180, 55, 45, new List<TypeElement>() { TypeElement.Glace }, @"\Images\Onigali.png");
            Pokemon p4 = new Pokemon("Lucario", 165, 70, 35, new List<TypeElement>() { TypeElement.Sol }, @"\Images\Lucario.png");
            Pokemon p5 = new Pokemon("Tortank", 220, 60, 30, new List<TypeElement>() { TypeElement.Eau, TypeElement.Sol }, @"\Images\Tortank.png");
            Pokemon p6 = new Pokemon("Germinion", 140, 65, 25, new List<TypeElement>() { TypeElement.Plante }, @"\Images\Germinion.png");
            Pokemon p7 = new Pokemon("Groudon", 200, 85, 35, new List<TypeElement>() { TypeElement.Feu, TypeElement.Sol}, @"\Images\Groudon.png");
            Pokemon p8 = new Pokemon("Kyogre", 210, 75, 35, new List<TypeElement>() { TypeElement.Eau, TypeElement.Vol }, @"\Images\Kyogre.png");
            Pokemons.Add(p1);
            Pokemons.Add(p2);
            Pokemons.Add(p3);
            Pokemons.Add(p4);
